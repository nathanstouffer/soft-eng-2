...
\begin{enumerate}[(a)]
	\item We depict the graph below
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
	\item % TODO test paths that achieve NC but not EC
	\item % TODO test paths that achieve EC but not EPC
	\item % TODO test paths that achieve EPC
\end{enumerate}
...
\begin{enumerate}[(a)]
	\item We depict the graph below
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
	\item % TODO TR for EPC (should have 12 of length 2)
	\item % TODO Do given test paths satisfy EPC?
\end{enumerate}
